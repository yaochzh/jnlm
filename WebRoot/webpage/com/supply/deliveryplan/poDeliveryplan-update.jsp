...
<script type="text/javascript">
	...
	function checkvehicle() {
		...
		for ( var i = 0; i < size; i++) {
			var vehiclelicense = document.getElementById("poDeliveryplanBList["
					+ i + "].vehiclelicense").value;
			//var carrier = document.getElementById("poDeliveryplanBList[" + i
			//		+ "].carrier").value;
		...
		if (materialcode == '110500000') {
			for ( var i = 0; i < size; i++) {
				var outpoundbillcode = document
						.getElementById("poDeliveryplanBList[" + i
								+ "].outpoundbillcode").value;
		...
		for ( var i = 0; i < size; i++) {
			for ( var j = i + 1; j < size; j++) {
				var vehiclelicense = document
						.getElementById("poDeliveryplanBList[" + i
								+ "].vehiclelicense").value;
				//var carrier = document.getElementById("poDeliveryplanBList["
				//		+ i + "].carrier").value;
				var vehiclelicense1 = document
						.getElementById("poDeliveryplanBList[" + j
								+ "].vehiclelicense").value;
				//var carrier1 = document.getElementById("poDeliveryplanBList["
				//		+ j + "].carrier").value;
	...
	function myChange(code, id) {
		...
		$
				.ajax({
					type : "POST",
					url : "poDeliveryplanController.do?queryByCode&code="
							+ code + "&id=" + id + "",// 请求的action路径
...
<body style="overflow-x: hidden;">
	<t:formvalid formid="formobj" dialog="true" usePlugin="password"
		...
		action="poDeliveryplanController.do?doUpdate"
		...
		<table cellpadding="0" cellspacing="1" class="formtable">
			<tr>
				...
				<td class="value"><input id="deliveryplancode"
					...
					class="inputxt" value='${poDeliveryplanPage.deliveryplancode}'
					readOnly="true"> <span class="Validform_checktip"></span> <label
					class="Validform_label" style="display: none;">计划单号</label>
				</td>
				...
				<td class="value"><input id="contractcode" name="contractcode"
					...
					value='${poDeliveryplanPage.contractcode}' readOnly="true">
					<span class="Validform_checktip"></span> <label
					class="Validform_label" style="display: none;">合同编号</label>
				</td>
				<td align="right"><label class="Validform_label">采购订单号:</label>
				</td>
				<td class="value"><input id="poordercode" name="poordercode"
					type="text" style="width: 150px" class="inputxt"
					value='${poDeliveryplanPage.poordercode}' readOnly="true">
					<span class="Validform_checktip"></span> <label
					class="Validform_label" style="display: none;">采购订单号</label>
				</td>
			...
			<tr>
				...
				<td class="value"><input id="supplername" name="supplername"
					type="text" style="width: 150px" class="inputxt"
					value='${poDeliveryplanPage.supplername}' readOnly="true">
					<span class="Validform_checktip"></span> <label
					class="Validform_label" style="display: none;">供应商名称</label>
				</td>
				<td align="right"><label class="Validform_label">物料编码:</label>
				</td>
				<td class="value"><input id="materialcode" name="materialcode"
					type="text" style="width: 150px" class="inputxt"
					value='${poDeliveryplanPage.materialcode}' readOnly="true">
					<span class="Validform_checktip"></span> <label
					class="Validform_label" style="display: none;">物料编码</label>
				</td>
				<td align="right"><label class="Validform_label">物料名称:</label>
				</td>
				<td class="value"><input id="materialname" name="materialname"
					type="text" style="width: 150px" class="inputxt"
					value='${poDeliveryplanPage.materialname}' readOnly="true">
					<span class="Validform_checktip"></span> <label
					class="Validform_label" style="display: none;">物料名称</label>
				</td>
			</tr>
			<tr>
				...
				<td class="value"><input id="unloadplace" name="unloadplace"
					...
					class="Validform_checktip"></span> <label class="Validform_label"
					style="display: none;">卸货地点</label>
				</td>
				<td align="right"><label class="Validform_label">仓库:</label>
				</td>
				<td class="value"><input id="store" name="store" type="text"
					style="width: 150px" class="inputxt"
					value='${poDeliveryplanPage.store}'> <span
					class="Validform_checktip"></span> <label class="Validform_label"
					style="display: none;">仓库</label>
				</td>
			</tr>
			<tr>
				...
				<td class="value"><input id="expiredate" name="expiredate"
					...
					<span class="Validform_checktip"></span> <label
					class="Validform_label" style="display: none;">到期日期</label>
				</td>
				...
				<td class="value"><input id="surplusnum" name="surplusnum"
					...
					class="Validform_checktip"></span> <label class="Validform_label"
					style="display: none;">剩余数量</label>
				</td>
				<td align="right"><label class="Validform_label">运输商名称:</label>
				</td>
				<td class="value"><input id="tranname" name="tranname"
					type="text" style="width: 150px" class="inputxt"
					value='${poDeliveryplanPage.tranname}' readOnly="true"> <span
					class="Validform_checktip"></span> <label class="Validform_label"
					style="display: none;">运输商名称</label>
				</td>
			</tr>
			<tr>
				...
				<td class="value"><span class="Validform_checktip"></span> <label
		...
		<tbody id="add_poDeliveryplanB_table_template">
			<tr>
				...
				<%--<td align="left"><t:dictSelect
						id="poDeliveryplanBList[#index#].carrier"
						field="poDeliveryplanBList[#index#].carrier" type="list"
						dictCondition="fuck" dictTable="bd_carrier" dictField="id"
						dictText="carriername" defaultVal="${poVal.carrier }" hasLabel="true" title="承运单位"></t:dictSelect>
...
<td align="left"><input
				...
				<td align="left"><input
					...
					type="text" class="inputxt" style="width:120px;"> <label
					class="Validform_label" style="display: none;">含量</label>
				</td>
				<td align="left"><input
				...
				<td align="left"><input
					...
					style="display: none;">送货日期</label>
				</td>
				<td align="left"><input
					name="poDeliveryplanBList[#index#].plandate" maxlength="32"
					type="text" class="Wdate" onClick="WdatePicker()"
					style="width:120px;"> <label class="Validform_label"
					style="display: none;">计划到货日期</label>
				</td>
				<td align="left"><input
					name="poDeliveryplanBList[#index#].discou" maxlength="9"
					type="text" class="inputxt" style="width:120px;"> <label
					class="Validform_label" style="display: none;">折百</label>
				</td>
				
				<td align="left"><input
					name="poDeliveryplanBList[#index#].meafinish" maxlength="9"
					type="text" class="inputxt" style="width:120px;"> <label
					class="Validform_label" style="display: none;">计量完成</label></td>
				<td align="left"><input
					name="poDeliveryplanBList[#index#].tarenum" maxlength="9"
					type="text" class="inputxt" style="width:120px;"> <label
					class="Validform_label" style="display: none;">皮重</label></td>
				<td align="left"><input
					name="poDeliveryplanBList[#index#].grossnum" maxlength="9"
					type="text" class="inputxt" style="width:120px;"> <label
					class="Validform_label" style="display: none;">毛重</label></td>
				<td align="left"><input
					name="poDeliveryplanBList[#index#].netnum" maxlength="9"
					type="text" class="inputxt" style="width:120px;"> <label
					class="Validform_label" style="display: none;">净重</label></td>
				--%><td align="left"><t:dictSelect
						id="poDeliveryplanBList[#index#].vehiclelicense"
						field="poDeliveryplanBList[#index#].vehiclelicense" type="list"
						dictCondition="fuck" dictTable="bd_vehicle" dictField="id"
						dictText="vehiclelicense" defaultVal="${poVal.vehiclelicense }" hasLabel="true"
						title="车牌号"></t:dictSelect> <label class="Validform_label"
					style="display: none;">车牌号</label>
				</td>
				<td align="left"><input
					id="poDeliveryplanBList[#index#].drivername"
				...
				<td align="left"><input
					id="poDeliveryplanBList[#index#].idcard"
				...
				<td align="left"><input
					id="poDeliveryplanBList[#index#].loadnum"
					name="poDeliveryplanBList[#index#].loadnum" maxlength="9"
					type="text" class="inputxt" style="width:120px;"> <label
				...
				<td align="left"><input
					name="poDeliveryplanBList[#index#].outnetnum" maxlength="9"
					type="text" class="inputxt" style="width:120px;" 
					 onblur="addTwo" datatype = "*"> <label class="Validform_label"
					style="display: none;">出厂净重</label></td>
				<td align="left"><input
					name="poDeliveryplanBList[#index#].outpoundbillcode" maxlength="20"
					id="poDeliveryplanBList[#index#].outpoundbillcode" type="text" datatype = "*"
					class="inputxt" style="width:120px;"> <label
					class="Validform_label" style="display: none;">出厂磅单号</label></td>
				<td align="left"><input
					name="poDeliveryplanBList[#index#].outbalancenum" maxlength="9"
					type="text" class="inputxt" style="width:120px;" datatype = "*"
					> <label class="Validform_label"
					style="display: none;">出厂结算量</label></td>
			</tr>
		</tbody>
	</table>
</body>
