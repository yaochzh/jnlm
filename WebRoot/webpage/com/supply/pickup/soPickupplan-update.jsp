...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="soPickupplanController.do?doUpdate" >
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
					  <input id="createDate" name="createDate" type="text" style="width: 150px" 
		      						class="Wdate" onClick="WdatePicker()"  value='<fmt:formatDate value='${soPickupplanPage.createDate}' type="date" pattern="yyyy-MM-dd"/>'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					  <input id="updateDate" name="updateDate" type="text" style="width: 150px" 
		      						class="Wdate" onClick="WdatePicker()"  value='<fmt:formatDate value='${soPickupplanPage.updateDate}' type="date" pattern="yyyy-MM-dd"/>'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="sysOrgCode" name="sysOrgCode" type="text" style="width: 150px" class="inputxt" value='${soPickupplanPage.sysOrgCode}'>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="sysCompanyCode" name="sysCompanyCode" type="text" style="width: 150px" class="inputxt" value='${soPickupplanPage.sysCompanyCode}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					  <input id="createDatetime" name="createDatetime" type="text" style="width: 150px" 
		      						class="Wdate" onClick="WdatePicker()"  value='<fmt:formatDate value='${soPickupplanPage.createDatetime}' type="date" pattern="yyyy-MM-dd"/>'>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="pickupplancode" name="pickupplancode" type="text" style="width: 150px" class="inputxt" value='${soPickupplanPage.pickupplancode}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					  <input id="expiredate" name="expiredate" type="text" style="width: 150px" 
		      						class="Wdate" onClick="WdatePicker()"  value='<fmt:formatDate value='${soPickupplanPage.expiredate}' type="date" pattern="yyyy-MM-dd"/>'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="deliver" name="deliver" type="text" style="width: 150px" class="inputxt" value='${soPickupplanPage.deliver}'>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="surplusnum" name="surplusnum" type="text" style="width: 150px" class="inputxt" value='${soPickupplanPage.surplusnum}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="vnote" name="vnote" type="text" style="width: 150px" class="inputxt" value='${soPickupplanPage.vnote}'>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="packtype" name="packtype" type="text" style="width: 150px" class="inputxt" value='${soPickupplanPage.packtype}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					  <input id="pickupbegindate" name="pickupbegindate" type="text" style="width: 150px" 
		      						class="Wdate" onClick="WdatePicker()"  value='<fmt:formatDate value='${soPickupplanPage.pickupbegindate}' type="date" pattern="yyyy-MM-dd"/>'>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="carrier" name="carrier" type="text" style="width: 150px" class="inputxt" value='${soPickupplanPage.carrier}'>
				<span class="Validform_checktip"></span>
		...
		<tbody id="add_soPickupplanB_table_template">
			<tr>
			 ...
			 <td align="center"><input style="width:20px;" type="checkbox" name="ck"/></td>
				  ...
				  <td align="left">
					  	<input name="soPickupplanBList[#index#].vehiclelicense" maxlength="32" 
					  		type="text" class="inputxt"  style="width:120px;"
					  		>
