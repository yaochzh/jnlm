...
<script type="text/javascript">
	...
	function checkvehicle() {
		...
		for ( var i = 0; i < size; i++) {
			var vehiclelicense = document.getElementById("soPickupplanBList["
					+ i + "].vehiclelicense").value;
			//var carrier = document.getElementById("soPickupplanBList[" + i
			//		+ "].carrier").value;
			...
			var myselect = document.getElementById("soPickupplanBList[" + i
					+ "].vehiclelicense");
		...
		for ( var i = 0; i < size; i++) {
			for ( var j = i + 1; j < size; j++) {
				var vehiclelicense = document
						.getElementById("soPickupplanBList[" + i
								+ "].vehiclelicense").value;
				//var carrier = document.getElementById("soPickupplanBList[" + i
				//		+ "].carrier").value;
				var vehiclelicense1 = document
						.getElementById("soPickupplanBList[" + j
								+ "].vehiclelicense").value;
				//var carrier1 = document.getElementById("soPickupplanBList[" + j
				//		+ "].carrier").value;
	...
	function myChange(code, id) {
		...
		$.ajax({
					type : "POST",
					url : "soPickupplanController.do?queryByCode&code=" + code
							+ "&id=" + id + "",// 请求的action路径
...
<body style="overflow-x: hidden;">
	<t:formvalid formid="formobj" dialog="true" usePlugin="password"
		...
		<input id="trancode" name="trancode" type="hidden"
			value="${soPickupplanPage.trancode }">
		<table cellpadding="0" cellspacing="1" class="formtable">
			<tr>
				...
				<td class="value"><input id="createDate" name="createDate"
					...
					class="Validform_label" style="display: none;">单据日期</label>
				</td>
				...
				<td class="value"><input id="pickupplancode"
					...
					class="inputxt" value='${soPickupplanPage.pickupplancode}' readOnly="true">
					<span class="Validform_checktip"></span> <label
				...
				<td class="value"><input id="soordercode" name="soordercode"
					...
					style="display: none;">销售订单号</label>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="value"><t:dictSelect id="delivercustomer"
					...
					class="Validform_checktip"></span> <label class="Validform_label"
					style="display: none;">付款客户</label>
				</td>-->
				<td align="right"><label class="Validform_label">运输商名称:</label>
				</td>
				<td class="value"><input id="tranname" name="tranname" type="text"
					style="width: 150px" class="inputxt"
					value='${soPickupplanPage.tranname}' readOnly="true"> <span
					class="Validform_checktip"></span> <label class="Validform_label"
			...
			<tr>
				...
				<td class="value"><input id="expiredate" name="expiredate"
					type="text" style="width: 150px" class="Wdate"
					onClick="WdatePicker()"
					value='<fmt:formatDate value='${soPickupplanPage.expiredate}' type="date" pattern="yyyy-MM-dd"/>'>
					<span class="Validform_checktip"></span> <label
					class="Validform_label" style="display: none;">到期日期</label>
				</td>
			</tr>
			<tr>
				<td align="right"><label class="Validform_label">已计划未提量</label>
				</td>
				<td class="value"><input id="planassnum" name="planassnum"
					type="text" style="width: 150px" class="inputxt"
					value='${soPickupplanPage.planassnum}'  readOnly="true"> <span
					class="Validform_checktip"></span> <label class="Validform_label"
					style="display: none;">已计划未提量</label>
				</td>
				<td align="right"><label class="Validform_label">接收单位</label>
				</td>
				<td class="value"><input id="receiver" name="receiver"
					type="text" style="width: 150px" class="inputxt"
					value='${soPickupplanPage.receiver}'> <span
					class="Validform_checktip"></span> <label class="Validform_label"
					style="display: none;">接收单位</label>
				</td>
		...
		<tbody id="add_soPickupplanB_table_template">
			<tr>
				...
				<!-- <td align="left"><t:dictSelect
						id="soPickupplanBList[#index#].carrier"
						field="soPickupplanBList[#index#].carrier" type="list"
						dictCondition="fuck" dictTable="bd_carrier" dictField="id"
						dictText="carriername" defaultVal="${poVal.carrier }" hasLabel="false" title="承运单位"></t:dictSelect>
				...
				<td align="left"><input
					...
					class="Validform_label" style="display: none;">收货数量</label></td>
				<td align="left"><input
				...
				<td align="left"><input
					...
					type="text" class="inputxt" style="width:120px;"> <label
					class="Validform_label" style="display: none;">剩余数量</label></td>
					
				<td align="left"><input
					name="soPickupplanBList[#index#].meafinish" maxlength="9"
					type="text" class="inputxt" style="width:120px;"> <label
					class="Validform_label" style="display: none;">计量完成</label>
				</td>
				<td align="left"><input
					name="soPickupplanBList[#index#].tarenum" maxlength="9" type="text"
					class="inputxt" style="width:120px;"> <label
					class="Validform_label" style="display: none;">皮重</label>
				</td>

				<td align="left"><input
					name="soPickupplanBList[#index#].grossnum" maxlength="9"
					type="text" class="inputxt" style="width:120px;" > <label
					class="Validform_label" style="display: none;">毛重</label>
				</td>

				<td align="left"><input
					name="soPickupplanBList[#index#].netnum" maxlength="9" type="text"
					class="inputxt" style="width:120px;" > <label
					class="Validform_label" style="display: none;">净重</label>
				</td> -->
				<td align="left"><form class="vehiclelicense">
						<t:dictSelect id="soPickupplanBList[#index#].vehiclelicense"
							field="soPickupplanBList[#index#].vehiclelicense" type="list" 
							dictCondition="fuck" dictTable="bd_vehicle" dictField="id"
							dictText="vehiclelicense" defaultVal="${poVal.vehiclelicense }" hasLabel="false"
							title="车牌号" datatype="*"></t:dictSelect>
				...
				<td align="left"><input id="soPickupplanBList[#index#].idcard"
					name="soPickupplanBList[#index#].idcard" maxlength="32" type="text"
					class="inputxt" style="width:120px;" datatype="*"> <label
					class="Validform_label" style="display: none;">身份证号</label></td>
				<td align="left"><input id="soPickupplanBList[#index#].phone"
					name="soPickupplanBList[#index#].phone" maxlength="32" type="text"
					class="inputxt" style="width:120px;" datatype="*"> <label
					class="Validform_label" style="display: none;">手机号</label>
				</td>
				<td align="left"><input id="soPickupplanBList[#index#].loadnum"
					name="soPickupplanBList[#index#].loadnum" maxlength="9" type="text"
					class="inputxt" style="width:120px;"> <label
					class="Validform_label" style="display: none;">标准载量</label>
				</td>
				<td align="left"><input
					name="soPickupplanBList[#index#].planpieces" maxlength="9"
					type="text" class="inputxt" style="width:120px;"> <label
					class="Validform_label" style="display: none;">预提包数</label></td>
				<td align="left"><input
					name="soPickupplanBList[#index#].plannum" maxlength="9" type="text"
					class="inputxt" style="width:120px;"> <label
					class="Validform_label" style="display: none;">预提数量</label>
				</td>
