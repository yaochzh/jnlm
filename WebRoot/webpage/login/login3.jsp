...
<body>
        ...
        <div class="inner">
            ...
            <div class="formLogin">
                <form name="formLogin" id="formLogin" action="loginController.do?login" check="loginController.do?checkuser" method="post">
                    ...
                    <div class="tip">
                        <input class="userName" name="userName" type="text" id="userNa想·me" title="" iscookie="true" value="admin" nullmsg="" />
                    </div>
                    <div class="tip">
                    ...
                    <div>
                        <div style="float: right; margin-left:-30px; margin-right: 40px;">
                           	 技术支持： <font color="red">自助平台</font>   &nbsp;&nbsp;&nbsp;  QQ群: <font color="red">111111</font> &nbsp;&nbsp;&nbsp;   
                        </div>
                    </div>
                </form>
            </div>
    ...
    <div class="clear"></div>
    <div id="versionBar">
        <div class="copyright">&copy; <t:mutiLang langKey="common.copyright"/> <span class="tip"><a href="http://user.qzone.qq.com/493978942/"  target="_blank" title=<t:mutiLang langKey="common.platform"/>>jeecg</a> <t:mutiLang langKey="common.browser.recommend"/><a href="http://user.qzone.qq.com/493978942/" target="_blank" title=<t:mutiLang langKey="common.platform"/>> Jeecg社区</a></span></div>
    </div>
    <!-- Link JScript-->
