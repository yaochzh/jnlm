...
<div style="display: none">
	<div id="p1" title="自助平台简介" collapsible="true">
		<div title="自助平台简介" collapsible="true" closable="flase" style="height:350px;" >
					<div style="margin-top: 14px;">
					<h3>简介</h3>
					<h3>架构说明</h3>
					<ul>
						<li>开发平台采用SpringMVC+MiniDao+UI快速开发库+ OnlineCoding开发组件 的基础架构,采用面向声明的开发模式， 基于泛型编写极少代码即可实现复杂的数据展示、数据编辑、<br>
						表单处理等功能，再配合代码生成器的使用,将J2EE的开发效率提高6倍以上，可以将代码减少60%以上。</li>
						<li><font color="red">v3.6 </font>最新版十二大技术点: <b>1.代码生成器</b> <b>2.用户权限</b> <b>3.Online在线开发</b> <b>简易Excel导入导出</b> <b>5.查询过滤器</b> <b>6.UI标签库</b> <b>7.国际化</b> <b>8.多数据源</b> <b>9.自定义表单</b> <b>10.在线报表配置</b> <b>11.系统日志监控</b> <b>12.首页风格切换</b></li>
						...
						<li>自助平台，经过专业性能压力测试，保证后台数据的准确性和页面访问速度</li>
						...
						<li>微信管家项目，请下载<a href="http://www.jeewx.com" target="_blank" style="color: red">Jeewx</a>，自助平台 业务产品</li>
						<li>要求JDK1.6+</li>
					</ul>
					</div>
