...
<!-- 顶部-->
<div region="north" border="false" title=" 自助系统 1.0" style="BACKGROUND: #E6E6FA; height: 85px; padding: 1px; overflow: hidden;">
...
<div region="south" border="false" style="height: 25px; overflow: hidden;">
    <div align="center" style="color: #CC99FF; padding-top: 2px">&copy;
        ...
        <span class="tip">
            <a href="http://www.jeecg.org" title=" 自助系统  <t:mutiLang langKey="system.version.number"/>"> 自助系统!  <t:mutiLang langKey="system.version.number"/></a>
            <t:mutiLang langKey="common.copyright"/>:
            <a href="#" title=" 自助系统  <t:mutiLang langKey="system.version.number"/>">自助系统!  <t:mutiLang langKey="system.version.number"/></a>
        </span>
    </div>
</div>
