...
<tr>
    ...
    <!--
        ...
        <div style="position: absolute; top: 75px; left: 33px;">自助系统 <span style="letter-spacing: -1px;">1.0</span></div>
    </td>
...
<div region="south" border="false" style="height: 25px; overflow: hidden;">
    <div align="center" style="color: #1fa3e5; padding-top: 2px">&copy;
        ...
        <span class="tip">
            <a href="http://user.qzone.qq.com/493978942/" title="自助系统 1.0">自助系统1.0</a>
